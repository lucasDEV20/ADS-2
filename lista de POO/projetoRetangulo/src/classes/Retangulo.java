...
public class Retangulo {
    ...
    public void setComprimento(int comprimento) throws Exception {
        if(comprimento <= 0) throw new Exception("O comprimento não pode ser menor ou igual á 0");
        this.comprimento = comprimento;
    }
    
    public void setLargura(int largura) throws Exception {
        if (largura <= 0) throw new Exception("A largura não pode ser menor ou igual á 0");
